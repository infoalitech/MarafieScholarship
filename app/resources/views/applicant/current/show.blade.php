...
$app = mysqli_query($conn, "SELECT a.*,d.name as dis_name, t.name as teh_name FROM `kiusc_job_applicants` a 
...
$user = mysqli_query($conn, "select * from z04cf_users where id = '".$app['user_id']."'");
$user = mysqli_fetch_assoc($user);

?>

<img src="logo.png" height="120px" style="float:left;">
<img src="pictures/<?php echo $app['picture'] ?>" height="150px" style="float:right; margin-right:0%; max-width: 20%">
...
<?php
$currente = mysqli_query($conn, "SELECT * FROM `kiusc_current` WHERE `applicant_id` = '$app_id'");
$curr = mysqli_fetch_assoc($currente); 

?>
<table width="100%">
    <tr>
        <td colspan=4 style="border:0px solid;font-size:20px;font-weight:200"> Current Semester</td>

    </tr>
    <tr>
        <td colspan=2> <b> Name of College/University </b> </td>
        <td colspan=2><?php echo $curr['collegeuni'] ?></td>
    </tr>
...
<fieldset>
    <legend><b><u><i> Under Taking</b></u></i> </legend>
...
<fieldset>
    <legend><i><b>Points to Ponder</b></i> </legend>
    <table width="80%">
        <fieldset>
            <legend><i><b>Application form check list</b></i> </legend>
        ...
        <fieldset>
            <legend><b><i>DO NOT:</i></b></legend>
            <ul>
                <li>Provide False/vague/incomplete information.</li>
                <li>Overview/ scratch on the form.</li>
            </ul>
